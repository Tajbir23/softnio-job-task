...
const Hero = () => {
  return (
    <div className=" bg-red-800 min-h-screen">
        ...
        <div className="lg:mx-48 mx-5 lg:py-28 py-5 flex lg:flex-row flex-col gap-10 lg:justify-between relative">
            <div className="w-full lg:my-auto flex flex-col gap-10 z-30">
                <div className="lg:absolute lg:w-3/4 w-full text-white  lg:bg-gradient-to-r lg:from-transparent lg:via-red-700/5  lg:to-red-700">
                    <h1 className="font-bold lg:text-[75px] text-6xl w-full uppercase">Taste the authentic
                    Saudi cuisine</h1>
                </div>
